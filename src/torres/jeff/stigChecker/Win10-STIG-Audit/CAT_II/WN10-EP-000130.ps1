...
$Regkey1 = (Get-ProcessMitigation -Name GROOVE.EXE).ImageLoad.BlockRemoteImageLoads
...
$Regkey9 = (Get-ProcessMitigation -Name GROOVE.EXE).ChildProcess.DisallowChildProcessCreation
...
$result = ($check.result,$check.result1,$check.result2,$check.result3,$check.result4,$check.result5,$check.result6,$check.result7,$check.result8,$check.result9)
