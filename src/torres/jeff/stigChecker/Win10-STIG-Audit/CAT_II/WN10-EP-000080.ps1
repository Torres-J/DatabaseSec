...
$Configuration = ""
$Regkey = (Get-ProcessMitigation -Name AcroRd32.exe).DEP.enable
$Regkey1 = (Get-ProcessMitigation -Name AcroRd32.exe).ASLR.BottomUP
$Regkey2 = (Get-ProcessMitigation -Name AcroRd32.exe).ASLR.ForceRelocateImages
$Regkey3 = (Get-ProcessMitigation -Name AcroRd32.exe).Payload.EnableExportAddressFilter
$Regkey4 = (Get-ProcessMitigation -Name AcroRd32.exe).Payload.EnableExportAddressFilterPlus
$Regkey5 = (Get-ProcessMitigation -Name AcroRd32.exe).Payload.EnableImportAddressFilter
$Regkey6 = (Get-ProcessMitigation -Name AcroRd32.exe).Payload.EnableRopStackPivot
$Regkey7 = (Get-ProcessMitigation -Name AcroRd32.exe).Payload.EnableRopCallerCheck
$Regkey8 = (Get-ProcessMitigation -Name AcroRd32.exe).Payload.EnableRopSimExec
