...
$Configuration = ""
$Regkey = (Get-ProcessMitigation -Name EXCEL.EXE).DEP.enable
$Regkey2 = (Get-ProcessMitigation -Name EXCEL.EXE).ASLR.ForceRelocateImages
$Regkey3 = (Get-ProcessMitigation -Name EXCEL.EXE).Payload.EnableExportAddressFilter
$Regkey4 = (Get-ProcessMitigation -Name EXCEL.EXE).Payload.EnableExportAddressFilterPlus
$Regkey5 = (Get-ProcessMitigation -Name EXCEL.EXE).Payload.EnableImportAddressFilter
$Regkey6 = (Get-ProcessMitigation -Name EXCEL.EXE).Payload.EnableRopStackPivot
$Regkey7 = (Get-ProcessMitigation -Name EXCEL.EXE).Payload.EnableRopCallerCheck
$Regkey8 = (Get-ProcessMitigation -Name EXCEL.EXE).Payload.EnableRopSimExec
