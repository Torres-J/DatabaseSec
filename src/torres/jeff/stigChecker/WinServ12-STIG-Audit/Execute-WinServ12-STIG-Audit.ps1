...
$Source = "C:\AutoSTIG\WinServ12-STIG-Audit*.csv"
...
$CATDir = "C:\AutoSTIG\WinServ12-STIG-Audit\CAT_I", "C:\AutoSTIG\WinServ12-STIG-Audit\CAT_II", "C:\AutoSTIG\WinServ12-STIG-Audit\CAT_III"
$Export = "C:\AutoSTIG\WinServ12-STIG-Audit\result\$Hostname-($Date)-result.csv"
}
if ($Hostname -eq $null){
...
Out-File -FilePath "C:\AutoSTIG\WinServ12-STIG-Audit\Result\done.txt"
